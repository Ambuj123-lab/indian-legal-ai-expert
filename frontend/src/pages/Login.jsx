                ...
                <div style={{
                    ...
                    <div style={{ flex: isMobile ? 'none' : 1, display: 'flex', flexDirection: 'column', justifyContent: isMobile ? 'flex-start' : 'center' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: isMobile ? '1.5rem' : '2.5rem' }}>
                            ...
                            <a href="https://ambuj-ai-portfolio.vercel.app/" target="_blank" rel="noopener noreferrer" style={{
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                gap: '0.6rem',
                                padding: isSmallMobile ? '0.7rem 1.2rem' : '0.6rem 1.8rem',
                                background: '#111', color: '#fff', fontWeight: 600, borderRadius: '8px',
                                textDecoration: 'none',
                                fontSize: '0.85rem',
                                boxShadow: '0 1px 4px rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.1)',
                                flex: 1
                            }}>
